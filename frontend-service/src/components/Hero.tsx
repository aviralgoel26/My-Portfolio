    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="container-width relative z-10 pt-20">
        ...
        >
          ...
          >
            Hi, I'm{" "}
            <span className="gradient-text">Aviral Goel</span>
          </motion.h1>
          ...
          <motion.p
            ...
            className="text-xl sm:text-2xl md:text-3xl text-muted-foreground mb-4 font-display"
          >
          ...
          >
            Building scalable, efficient, and user-centric software solutions
            that make an impact.
          </motion.p>
          ...
          >
            <Button
              size="lg"
              className="bg-gradient-primary hover:opacity-90 transition-opacity text-primary-foreground gap-2 px-6"
            ...
            <Button
              ...
              asChild
            >
              <a href="/Aviral Goel Mar CV2.pdf" download>
                <Download size={18} />
                Download Resume
              </a>
            </Button>
            <Button
              size="lg"
              variant="ghost"
              className="gap-2 px-6 hover:bg-secondary"
